                    ...
                    if ($level == 'admin') {
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <a href='mahasiswa/tambah_mahasiswa.php' class='btn btn-primary'>Tambah Data</a>
                            </div>
                            <div class="col-md-6">
                                <form action="mahasiswa/cari_mahasiswa.php" method="GET">
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)) {
                                        ...
                                        <tr>
                                            ...
                                            if ($level == 'admin') {
                                                ...
                                                echo "<td>
                                                    <a href='mahasiswa/edit_mahasiswa.php?nim={$data['nim']}' class='btn btn-primary'>Edit</a>
                                                    <a href='mahasiswa/delete_mahasiswa.php?nim={$data['nim']}' class='btn btn-danger' onclick=\"return confirm('Apakah anda yakin ingin menghapus ini ?')\">Hapus</a>
                                                </td>";
                                            }
                                            ?>
                                        </tr>
