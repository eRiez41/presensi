...
WHERE nama_matakuliah LIKE '%$keyword%' OR
      kode_matakuliah LIKE '%$keyword%' OR
      jenis LIKE '%$keyword%'");
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Cari Data matakuliah</title>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            while ($data = mysqli_fetch_array($tampil)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_matakuliah.php?nim=<?= $data['nim'] ?>" class='btn btn-primary'>Edit</a>
                                        <a href="delete_matakuliah.php?nim=<?= $data['nim'] ?>" class='btn btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                            }
