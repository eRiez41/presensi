                    ...
                    <div class="col-md-5 ">
                        <form method="POST" action="update_mahasiswa.php">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="hidden" name="nim_tmp" value="<?= $data['nim'] ?>" class="form-control" id="nim_tmp" required>

                                <input type="text" name="nim" value="<?= $data['nim'] ?>" class="form-control" id="nim" placeholder="Masukan NIM" required>
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" name="nama_mahasiswa" value="<?= $data['nama_mahasiswa'] ?>"
                                    class="form-control" id="nama_mahasiswa" placeholder="Masukan Nama Mahasiswa"
                                    required>
                            </div>
                            <div class="mb-3 mt-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tempat_lahir" value="<?= $data['tempat_lahir'] ?>"
                                    class="form-control" id="tempat_lahir" placeholder="Masukan Tempat Lahir" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="tahun_masuk" value="<?= $data['tahun_masuk'] ?>"
                                    class="form-control" id="tahun_masuk" placeholder="Masukan Tahun Masuk " required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <a href="../tampil_mahasiswa.php" class="btn btn-warning">Kembali</a> <button type="submit" class="btn btn-primary">Perbaharui</button>
                            </div>
                        </form>
                    </div>
                </div>
